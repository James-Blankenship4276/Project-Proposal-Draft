...
\begin{abstract}
We are writing about the group project for CSCI 352. The project will be about a short quiz game. It will also give information about a topic. The target audience is people that want to learn more about a topic or take a quiz.
\end{abstract}
...
\begin{itemize}
\item needs to choose difficulty.
\itme User needs to have the ablity to answer  questions, and get information on topic.
...
\begin{figure}[ht!]
\includegraphics[height=250px, width=350px]{Interface1.jpg}
